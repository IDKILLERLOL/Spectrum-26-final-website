  ...
  try {
    ...
    let res = cachedRegistrations.length > 0 ? cachedRegistrations : [
      ...
      },
      {
        ...
        teamMembers: [{ name: "Rohan Mehta" }],
        teamSize: 2,
        paymentRefId: "987654321098",
        amountPaid: 150,
        paymentStatus: "PENDING",
        pictureUrl: "",
        checkedIn: false,
      ...
      {
        id: "reg_demo_3",
        userEmail: "ananya.patel@example.com",
        ...
        teamMembers: [],
        teamSize: 1,
        paymentRefId: "456789012345",
        amountPaid: 80,
        paymentStatus: "APPROVED",
        pictureUrl: "",
        checkedIn: true,
        paymentVerifiedBy: "admin",
        paymentVerifiedAt: new Date(Date.now() - 10800000).toISOString(),
        sheetsSyncStatus: "SYNCED",
        emailSentAt: new Date(Date.now() - 10800000).toISOString(),
        createdAt: new Date(Date.now() - 10800000).toISOString(),
        updatedAt: new Date(Date.now() - 10800000).toISOString(),
      },
      {
        id: "reg_demo_4",
        userEmail: "dev.kapoor@example.com",
        fullName: "Dev Kapoor",
        phone: "9654321098",
        collegeName: "K.J. Somaiya",
        year: "1st Year",
        eventId: "bgmi",
        eventName: "BGMI",
        teamMembers: [{ name: "Karan Johar" }, { name: "Vikas Khanna" }, { name: "Siddharth Malhotra" }],
        teamSize: 4,
        paymentRefId: "789012345678",
        amountPaid: 200,
        paymentStatus: "PENDING",
        pictureUrl: "",
        checkedIn: false,
